  ...
  return (
    <>
      <div className='relative text-white h-screen'>
        ...
        <img src={ORIGINAL_IMG_BASE_URL + trendingContent?.backdrop_path} alt="Hero imdg" 
        ...
        <div className='absolute top-0 left-0 w-full h-full flex flex-col justify-center px-8 md:px-16 lg:px-32'>
          ...
          absolute w-full h-full top-0 left-0 -z-10'></div>
          <div className='max-w-2xl'>
            <h1 className='mt-4 text-6xl font-extrabold text-balance'>{trendingContent?.original_title}</h1>
            <p className='mt-2 text-lg'>{trendingContent?.release_date}  | {trendingContent?.adult ? "18+" : "PG-13"}</p>
